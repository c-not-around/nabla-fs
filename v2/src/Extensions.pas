...
static function Point.operator+(left, right: Point) := new Point(left.X + right.X, left.Y + right.Y);

function CompareFiles(fname1: string; fname2: string): integer;
external 'fcmp.dll' name 'CompareFiles';
